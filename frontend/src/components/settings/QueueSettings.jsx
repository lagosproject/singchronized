...
export default function QueueSettings() {
  ...
  return (
    <>
      <div>
        <h2 style={{ margin: '0 0 8px 0', fontSize: '1.75rem', fontWeight: 800, background: 'linear-gradient(to right, #ffffff, #a7f3d0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{t("queueSettings")}</h2>
        <p style={{ margin: '0', color: 'var(--text-secondary)' }}>{t("queueSettingsDesc")}</p>
      </div>
      ...
      <div className="glass-panel" style={{ padding: '24px', borderRadius: '12px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-color)', maxWidth: '650px' }}>
        <h3 style={{ margin: '0 0 8px 0', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Music size={18} color="var(--secondary)" /> {t("karaokeQueueSettings")}
        </h3>
        <p style={{ margin: '0 0 16px 0', fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
          {t("countdownDurationDesc")}
        </p>
